...
/**
  ...
  */
/mob/proc/create_chat_message(atom/movable/speaker, datum/language/message_language, raw_message, list/spans = list(), message_mode, atom/movable/message_loc)
	...
	new /datum/chatmessage(text, message_loc || speaker, src, spans)
